...
df= pd.read_csv("PMMD_data.csv") #"df" is "data frame"
print(df[:5])
...
app.layout = html.Div(style = {'backgroundColor': 'black'}, children=[
    ...
    html.H1('cekaty + BIT Mesra', style={'text-align': 'center', 'color':'gold', 'font-family':'georgia'}),
    
    html.H1("Air Quality Measurement Dashboard", style={'text-align': 'center', 'color':'white', 'font-family':'georgia'}),
...
#download action---------------------------------------------------
def func(n_clicks):
    return dcc.send_data_frame(df.to_csv, "PMMD_updated.csv")
